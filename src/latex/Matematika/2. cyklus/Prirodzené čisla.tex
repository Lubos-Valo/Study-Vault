...
Prirodzené čísla zapisujeme v desiatkovej číselnej sústave pomocou číslic \(0\), \(1\), \(2\), \(3\), \(4\), \(5\), \(6\), \(7\), \(8\) a \(9\). Čǐsla môžeme zapisovať v skrátenom alebo rozvinutom tvare. Bežne sa čísla zapisujú v skrátenom tvare, pritom dodržujeme zásadu zapisovania číslic do skupiniek po tri, začíname od jednotiek. Podľa počtu číslic (cifier) určujeme, o \textbf{koľkociferné prirodzené číslo} ide. Poznáme napríklad prirodzené čísla:
\begin{itemize}
